...
import { LayoutDashboard, ListOrdered, Wifi, Users, LogOut, Palette, Eye, Activity, ScrollText, HeartPulse, Wrench, Ticket, Share2, CalendarClock, BellRing, LineChart, Smartphone, History, Cable, Siren, RadioTower, Router, ShieldAlert, ShieldCheck, PlugZap, FileClock, Gauge, Waypoints } from "lucide-react";
...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/upnp", label: "Port Forwards", icon: Waypoints, adminOnly: true },
        ...
        <div className="mb-8">
          ...
          {versionStatus.upToDate === false && versionStatus.latest && (
            <p className="mt-1 w-fit rounded bg-amber-500/15 px-1.5 py-0.5 text-[10px] font-medium text-amber-700 dark:text-amber-400">
              ...
              {versionStatus.latest.version} — run ./install.sh update
            </p>
          )}
        </div>
