## [3.3.6](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v3.3.5...v3.3.6) (2026-07-23)


### Bug Fixes

* **ci:** scan before releasing so a blocked image can't burn a version ([#22](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/22)) ([ac16823](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/ac16823b4dec41f8d00c79df136976af47465332))

## [3.3.5](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v3.3.4...v3.3.5) (2026-07-23)


### Bug Fixes

* **ci:** reclaim runner disk and stop grype errors masquerading as findings ([#21](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/21)) ([62e4ae3](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/62e4ae3105d3ff5eabb69437ff0970d67ef866df)), closes [#18](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/18)

## [3.3.4](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v3.3.3...v3.3.4) (2026-07-23)


### Bug Fixes

* show grype's CRITICAL gate output instead of running it -q ([#18](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/18)) ([70479fe](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/70479fe43f8c1ae3983b59ae75e2c31c317bc4f7))

## [3.3.3](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v3.3.2...v3.3.3) (2026-07-23)


### Bug Fixes

* bump next to 16.2.11 to clear the release image-scan gate ([#19](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/19)) ([f9a3c2f](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/f9a3c2f920011d710e272671e09c063d0b1243aa))
* trigger release for the 2026-07-15 monitoring-resilience batch ([#190](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/190)) ([fcf2493](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/fcf2493bc3854e4db577532d29d1d4e65790c477))

## [3.3.2](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v3.3.1...v3.3.2) (2026-07-20)


### Bug Fixes

* use RELEASE_TOKEN for semantic-release's GitHub API calls too ([e279da2](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/e279da2071c82322fec8587fcd0b277c9abfa734))

## [3.3.1](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v3.3.0...v3.3.1) (2026-07-20)


### Bug Fixes

* revert typescript 6->7 bump, breaks next build ([#14](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/14)) ([c01b55d](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/c01b55d766b24ea94d688e004770da1991dd0390)), closes [#11](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/11)
* sync lockfile drift, drop bot-approval gate ([#13](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/13)) ([9453613](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/9453613023b708f866ecdb0af662980acafc2067))
* use an admin PAT for the release commit push ([#16](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/16)) ([203f419](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/203f419202439077e21e19c9e062a23522e98fd2))
* use buildx --push to avoid GHCR unknown blob on push ([#15](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/15)) ([cbbb075](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/cbbb0758e4de4147bda6e111e34520d274bb5679)), closes [#190](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/190)

# [3.3.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v3.2.0...v3.3.0) (2026-07-14)


### Features

* Traefik log dashboard with portal sign-in, pcap fix + port picker, update-badge fix, locations popup + 2026-07-14 batch ([#186](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/186)) ([6de99d8](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/6de99d847e369a4eab0f2b2eef8d285b0ea583fc))

# [3.2.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v3.1.0...v3.2.0) (2026-07-13)


### Bug Fixes

* setup/update auto-fill a blank IMAGE_TAG from the checked-out branch ([#174](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/174)) ([a737a61](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/a737a616786e9e386abb2a74c7a425157e25da40))
* **split:** portal preview opens on the guest-serving host under a split ([#181](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/181)) ([65be6e3](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/65be6e3da24bd2d5a5f390e40119df6262690684))


### Features

* guest/admin process split, System Health panel, load-test runner + 2026-07-12 batch ([#180](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/180)) ([a60bca0](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/a60bca0a0157b56a9694b2b1f786ba67e6d4e5eb))
* network security suite, admin hardening, M365 mail, map/timeline UX ([#176](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/176)) ([93c5894](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/93c589439183bf2c61c091e210ecf56110ed861e))
* nightly channel — ungated build-only branch wired into the updater ([#173](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/173)) ([b93e9d6](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/b93e9d6cc91f4de74f6cdd3ffce532ac75615908))
* sponsored guest access, DoD compliance, and the NOC/analytics suite ([#178](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/178)) ([d4589a0](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/d4589a06aa0195843f69dbfb75d03c7930232bda))
* test foundation, security hardening, ops robustness, and the device-ignore batch ([#177](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/177)) ([443bb5b](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/443bb5bccaf181f6ef4fe6c34d6fea1e70506048))

# [3.1.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v3.0.0...v3.1.0) (2026-07-08)
...
* what's-new dialog renders markdown; changelog links use the public host ([#169](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/169)) ([2a5f081](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/2a5f08108175da33af1f00e28843c8851cca39ea))

# [3.0.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v2.0.1...v3.0.0) (2026-07-08)


* feat!: portal container runs as non-root (node, port 3000) ([f0bcb2c](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/f0bcb2c0ff422a78d0d7355f47079a34328704ad))


### Bug Fixes

* drop npm from the runtime image; allow-list ssh2 fixture key (weekly scan green) ([#158](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/158)) ([79a2fa7](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/79a2fa7fdb5ae4c5a5302a0c4ebf0447e2fec021))
* let CHANGELOG.md into the build context — the image COPY needs it ([#162](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/162)) ([5d1eb5e](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/5d1eb5e924c638153ed0d6b3e346b79a32ca4e81))
* pin public resolvers for the ACME DNS-01 propagation check ([2884558](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/28845584925429b272746bc4b6a3f9d6e5ce8417))
* stop the admin sidebar sliding on scroll (footer drag + dev banner offset) ([#157](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/157)) ([367ef68](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/367ef6876734939a391cc1dd5ed05c03cfbc0c43))


### Features

* CI bakes the update-check token into the image, encrypted ([#164](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/164)) ([1d8d9c6](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/1d8d9c6873c8c48b1aca6551f3e4a84fe85f1b4f))
* dual-auth connection test, pre-auth allowances, sign-in connects device ([#163](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/163)) ([46e787d](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/46e787d82674f9a9f9281da6f5c450c6ba2466bc))
* Restart-Traefik button (reauth-gated) via socket-free ops sidecar ([14ed5a1](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/14ed5a14fa8bf779c88589a30e061b5eca75912c))
* settings UX batch, admin account lifecycle, hotspot + test-connection fixes ([#160](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/160)) ([8ebf64f](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/8ebf64f4c7ebceeb6fd96d3dbbe8e077107800eb))
* Test-proxy button — live end-to-end Traefik checks in the GUI ([cc51f37](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/cc51f373ace926642eb4ffb0ade32a2d5353f0c3))
* what's-new popup, update-check channel, Traefik config preview, UI cleanups ([#161](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/161)) ([427559d](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/427559dd3583eaf3885b57ea861233cf11a81223))
* yellow development-build banner on every page ([a059772](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/a059772ffcd85ea2fc44cbc12f68afa62057caae))
...
## [2.0.1](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v2.0.0...v2.0.1) (2026-07-07)


### Bug Fixes

* ship the /api/traefik/config route + IPv4 healthcheck ([11d9d19](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/11d9d19964ae8c330b01c41d6a1894fd031a05ec))

# [2.0.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.29.0...v2.0.0) (2026-07-07)


* feat!: portal-managed Traefik replaces Pangolin; bridge networking replaces macvlan ([ebfc282](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/ebfc282a5d363f17f7529598fe4a2e8041829bed))
...
# [1.29.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.28.0...v1.29.0) (2026-07-07)


### Features

* auto-update on host reboot — [@reboot](https://git.example.com/reboot) cron + docker-ready wait ([29b3fa1](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/29b3fa18f39c366489820189f78de7a9687c422a))
* standalone image — 1.55 GB → 620 MB ([5478f3f](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/5478f3f870937fd1c76167f86e3766c14f6d30c4))


### Performance Improvements

* micro-cache the dashboard live snapshot + monitor cache headers ([3d93690](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/3d93690126f1e690c65db5138e7b18fa5980ca64))

# [1.28.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.27.0...v1.28.0) (2026-07-07)


### Features

* setup/update .env reconcile + deploy migration verification ([4487299](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/44872995896d28d61b782dbc746dbfa07c13e370))

# [1.27.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.26.0...v1.27.0) (2026-07-07)


### Bug Fixes

* hotspot Apply — verify the write stuck + clear unneeded portal settings ([2d68c73](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/2d68c739fe1cea1ca841b0738588bd6fa6250b73))
* usage bars invisible in dark mode — use the chart palette, not the brand color ([910a4c0](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/910a4c0871a5b78a7aa1d15e63d87865140938bc)), closes [#171717](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/171717) [#2563eb](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/2563eb) [#3b82f6](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/3b82f6)


### Features

* update check — /api/version + admin-sidebar badge (latest vs running) ([28a31c4](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/28a31c4fecc016b367d74af75ca870f929f04c29))
* UPDATE_CHECK_TOKEN env fallback for the update check (zero-UI setup) ([9975099](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/9975099f12699c18c9eda7bb417a68817704ef10))

# [1.26.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.25.0...v1.26.0) (2026-07-07)


### Features

* Network Review tab — advisory firewall rule builder + stability recs ([5cdb9dc](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/5cdb9dccdf90053e5a9206ba06561922606d8078))

# [1.25.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.24.3...v1.25.0) (2026-07-07)


### Features

* multi-WAN support — per-link visibility + wan_link alerts ([50102f3](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/50102f39f475156b123005dacf8a04a00312d5d2))

## [1.24.3](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.24.2...v1.24.3) (2026-07-07)


### Bug Fixes

* security hardening — CSV/XSS injection fixes, tests in CI, architecture & ops docs ([27bfe87](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/27bfe879c2b504f9e8b82ac655b9fc596cddd278))

## [1.24.2](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.24.1...v1.24.2) (2026-07-07)


### Bug Fixes

* UniFi settings page crashed after save + Test Connection ([5e3cdf1](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/5e3cdf167a59660d7965197749404d6e9ab11294))

## [1.24.1](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.24.0...v1.24.1) (2026-07-07)


### Bug Fixes

* first admin account gets the Traffic-data grant automatically ([f376696](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/f376696d1256cc6dd223793095eb99fabd04f6e6))

# [1.24.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.23.1...v1.24.0) (2026-07-07)
...
* duplicate-IP false-positive suppression (alarm gate + audit log) ([619e237](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/619e237fd028ca0472bad5d3bc7bb54d017c39b2))
* optional UniFi Integration-API key (supplements local account) ([d6d1e62](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/d6d1e62a1ba6dab7412b32ef47868b3f7a030b6e))

# [1.22.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.21.0...v1.22.0) (2026-07-06)


### Bug Fixes

* DHCP usage bar — make low (non-zero) usage visible ([804b5b7](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/804b5b727352a3e7816ee47c3e4a6c6e35cf37c3))


### Features

* stamp UniFi client note with guest name + last-5 phone on registration ([f7699c9](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/f7699c9e3f172023f639e9f064a1ddf00d2eb6fe))

# [1.21.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.20.1...v1.21.0) (2026-07-06)


### Features

* configurable live-view refresh interval (Phase 7, migration) ([68f1651](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/68f165188aa555a8ce59697cdb8a039db4b5d47b))
* GDPR SAR export filename = subject name + export timestamp ([29ac3e6](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/29ac3e63320e7178ff3daed30e69f1066e45fcb7))
* standalone login page — no admin sidebar when logged out ([35a0001](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/35a00014913ad28a70a6321f24efad3991cc2dcc))

## [1.20.1](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.20.0...v1.20.1) (2026-07-06)


### Bug Fixes

* /admin/status crash — move device-type filter const to a server-safe lib ([c90beaf](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/c90beafe048a49472b9c07cb450b87cf03c0988a)), closes [#99](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/99)

# [1.20.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.19.0...v1.20.0) (2026-07-06)


### Features

* guest-portal preview from admin settings ([aaac9ae](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/aaac9aeec64be3326a20a3ee969ad4184e11ebf5))

# [1.19.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.18.0...v1.19.0) (2026-07-06)


### Features

* DHCP-pool exhaustion check + alert (Phase 6) ([ef22062](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/ef2206217d0b6c74e51d49c28e44e872782d50ea))
* per-AP client-load breakdown on the dashboard (Phase 5) ([5950a3c](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/5950a3cff2bbf7d1ee34bc78266051165576690b))
* speedtest history chart on the metrics page (Phase 6) ([65384d6](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/65384d678541ac7fed87a91ad6e2f4008c7344c2))

# [1.18.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.17.0...v1.18.0) (2026-07-06)


### Features

* bulk delete on the Users directory (Phase 7 QoL) ([42308b5](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/42308b5e6ebd6f7e9af5e06fe1eccb3c03d656cb))
* network health score on the dashboard (Phase 6) ([3d573f8](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/3d573f838693e788bfb73403e597f485b95c9adb))
* timeline drill-down to alert/event detail (Phase 7 QoL) ([d4ebb17](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/d4ebb1714195a159d0067fe308015372b65e7d22))

# [1.17.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.16.0...v1.17.0) (2026-07-06)


### Bug Fixes

* CI builds the current main tip, not the triggering commit ([f6f0e2b](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/f6f0e2bec01794147e4c6be1a75fce896b021991)), closes [#105](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/105)


### Features

* block dialog + CSV export for Clients/Ports (Phase 7 QoL) ([6dc5c29](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/6dc5c29b46f16ee73c212bfe1b68a08c695e33e8))
* persistent table filters for Users/Logs/Audit (Phase 7 QoL) ([64e1cff](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/64e1cff2483d86615ae900c95559fdcc62737fc7))
* production retention nudge on the dashboard (Phase 7 QoL) ([b8226b8](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/b8226b84f3158540ef54300aaa2f7c59f5780d01))

# [1.16.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.15.0...v1.16.0) (2026-07-06)


### Features

* per-client bandwidth throttle (Phase 6, migration) ([64bf67c](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/64bf67c747034ee970177fe80e3604beec4d133d))

# [1.15.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.14.0...v1.15.0) (2026-07-06)


### Features

* first-seen device alert (Phase 8, migration) ([075a25a](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/075a25a99c07a70873b9628a6841ef6b9c0cc5e0))

# [1.14.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.13.0...v1.14.0) (2026-07-06)


### Features

* rogue-AP (evil-twin) detection (Phase 8) ([2a328cb](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/2a328cb034b241420ff426f2c2f9484eba9b9277))

# [1.13.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.12.0...v1.13.0) (2026-07-06)


### Features

* AP/DN/AN device-type filter across device views ([ae8e970](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/ae8e9707d162c81f6d83b5d0be23a54891a97416))

# [1.12.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.11.0...v1.12.0) (2026-07-06)


### Features

* failed-admin-login alerting (Phase 8) ([90dcaba](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/90dcabab12bc187b0e1f57abfa2dc067f5c448d2))
* security response headers (CSP/HSTS/frame-ancestors, Phase 8) ([dd736d1](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/dd736d189991b6b99a941708a84900a4e7289af5))

# [1.11.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.10.0...v1.11.0) (2026-07-06)


### Features

* npm audit in CI + fix stale workflow docs (Phase 8) ([f7b1d09](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/f7b1d090042eaec97ddd490e68ea2b965f3931d5))
* scheduler single-run guard via advisory lock (Phase 7) ([3a62e6b](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/3a62e6b8b6602290b75cab50aa0007d016230689))

# [1.10.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.9.2...v1.10.0) (2026-07-06)


### Features

* DB restore script + hardened backup (Phase 8) ([79217f3](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/79217f354621ef29cbff6ecd9fab842adebf13d0))
* separation of duties — no self role/traffic escalation (Phase 7) ([6817f23](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/6817f231df67de6f311c57396f7933fbb8c01cb7))

## [1.9.2](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.9.1...v1.9.2) (2026-07-06)


### Bug Fixes

* add .dockerignore so the image build is hermetic (unblocks CI build) ([a6577df](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/a6577dff12a7668a2de819eb75bffbbc2504031b))

## [1.9.1](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.9.0...v1.9.1) (2026-07-06)


### Bug Fixes

* deployed image now carries the released version (single CI pipeline) ([897836f](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/897836f90e04f3b2d39e4d9a1f0dc821e9670c4d))

# [1.9.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.8.0...v1.9.0) (2026-07-06)


### Features

* GDPR erasure also blocks the subject's device MACs ([e344c21](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/e344c21ae0892b489c36ac9eae2d47557d1d03be))

# [1.8.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.7.1...v1.8.0) (2026-07-06)


### Features

* map device controls — locate toggle, per-device pcap, PoE by capability ([69cf23e](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/69cf23ebda331c83763b52ec232d27bba43b0823))

## [1.7.1](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.7.0...v1.7.1) (2026-07-06)
...
* client-insight toolkit — detail windows, extender tool, port devices, pcap ([3c4b076](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/3c4b076e29b8d263126064bff64b8be0cbed96a4))

# [1.6.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.5.0...v1.6.0) (2026-07-06)


### Bug Fixes

* SSH terminal sizing in the map dialog ([ec31783](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/ec31783a0a75786fd4828ac196ce2a0349bf4662))


### Features

* NOC toolkit — issues board, live map overlay, AP tab, filters ([b650e8f](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/b650e8fd97075ae8bfcb2b692282e2602320cd52))
* unified branding — favicon, title template, builder credit ([2164871](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/216487145909ba7ff02c26af04d13b78dd8c37ac))

# [1.5.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.4.2...v1.5.0) (2026-07-06)


### Bug Fixes

* countdown hydration warning + broken renew link in expiry email ([cd4240a](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/cd4240aab873f8f83969c28caa42cc3729c74146))
* list blocked devices on /admin/clients so they can be unblocked ([e8565fa](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/e8565fa43b6b684e53b1999302510093473174ec))


### Features

* block a client from the network, with who/why/when recorded ([a9ee956](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/a9ee95611d78240c58d74bfa70665e33e06756ad))
* professional UI pass — theme-aware charts + real icons ([a920bba](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/a920bbac44aba924d72f849f59778916b8c41a04))

## [1.4.2](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.4.1...v1.4.2) (2026-07-06)


### Bug Fixes

* remove the traffic usage bar, keep plain text ([792ba3a](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/792ba3a23a1dfb9c5f781e09036eefac606c922c))

## [1.4.1](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.4.0...v1.4.1) (2026-07-06)


### Bug Fixes

* scale traffic usage bars to the list's max, not its sum ([ec2a8cb](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/ec2a8cb0106c31c461590001ee75800f7b9f7ab3))

# [1.4.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.3.0...v1.4.0) (2026-07-06)


### Features

* correlated assurance timeline (alerts + health + events) ([f706c63](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/f706c6343e91175d87ba349ffa75e9be66fd15aa))

# [1.3.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.2.1...v1.3.0) (2026-07-06)


### Features

* flat switch-port inventory admin page ([715a407](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/715a407f9fe0f740756323ffca7767d88a2a9f87))
* live-ticking countdown on the guest devices page ([9753468](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/97534686fb2eec482edc5f3e1cd9f06ba9a51788))

## [1.2.1](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.2.0...v1.2.1) (2026-07-06)


### Bug Fixes

* resolve switch names too on the Clients page, not just APs ([d4bc4a6](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/d4bc4a6140fbe47db9ffdb78f4ca1d4fbe1992ab))

# [1.2.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.1.2...v1.2.0) (2026-07-06)


### Bug Fixes

* support a non-interactive registry pull token in setup/deploy ([f00ed74](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/f00ed7482adba1832c2ea98afce17d693890ef95))


### Features

* detect suspected consumer WiFi extenders/mesh nodes ([d714d14](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/d714d14dddc51b11ebc59565b0cfd19d0474a5c8)), closes [Hi#confidence](https://git.example.com/Hi/issues/confidence)
* hotel accommodation locations require a room number ([64aac83](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/64aac83ca17f01a40d520f1e2ee811ca459a7c64))


### Reverts

* move guest session secret back to .env-only ([a4a0995](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/a4a0995edf6dd35e23ece32a7450fa89a87a291d)), closes [#57](https://github.com/Blake-DK/unifi-captive-portal-suite/issues/57)

## [1.1.2](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.1.1...v1.1.2) (2026-07-04)


### Bug Fixes

* build the release image in the semantic-release job itself ([9880bec](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/9880becebb455d20dfe100e80254b54910eedeac))

## [1.1.1](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.1.0...v1.1.1) (2026-07-04)


### Bug Fixes

* drop [skip ci] from release commits so docker-publish runs ([25f5ae7](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/25f5ae71593e6c5f688311dbf9b6d25a615168f8))
* log in to the registry when a pull is unauthorized ([dc36d38](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/dc36d38eac5c9210ceef07ca1869c48498772caf))

# [1.1.0](https://github.com/Blake-DK/unifi-captive-portal-suite/compare/v1.0.0...v1.1.0) (2026-07-04)
...
* add cookieSecure/guestSessionSecret columns to SystemSettings ([2c92326](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/2c92326c4c4d7e322140c4bd493e3fa8ca84d01f))
* add semantic-release for automated Conventional Commits versioning ([8c43297](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/8c43297783ba0ff5d8ee4735ccc429c1517a1f91))
* encrypt secrets at rest (AES-256-GCM) ([3da33aa](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/3da33aa5d433f3678fdef4a773a67536037810c4))
* make .env infra-only, GUI-only for app settings ([5a7c1a1](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/5a7c1a1acfd4d634f8fd66113b495814b1308cc5))
* read cookieSecure/guestSessionSecret from DB, not env ([3dfc60b](https://github.com/Blake-DK/unifi-captive-portal-suite/commit/3dfc60b12495568c311b07032b418d455bdf2cf5))
...
### Ops
- **`install.sh setup` generates the admin password** — the one remaining manual
...
- **`.env` is infra-only now** — removed the `process.env` fallback for every
  ...
  `install.sh setup`'s post-generate message updated to match — they now only ask for
...
### Fixed
- **Registry hostname** — `docker-compose.yml`, `install.sh update`, and the CI publish
...
### Added
- **Backups & container health** (ops): `install.sh backup` runs a nightly gzip `pg_dump`
...
### Operational
- **`install.sh update`**: one-command host deploy (pull `:latest` -> restart ->
